				...
				<td colspan="" class="none_border">
					<table class="" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0"> <!-- table 1-->
						<tr class="bold pt13 padding">
							...
							<!-- @TanDoan:  add style="font-size:25px" -->
							<td colspan="12" rowspan="2" class="aleft padding none_border" style="font-size:27px">LỆNH SẢN XUẤT/PRODUCTION ORDER</td>
						...
						<tr style="height:28%">
							<td colspan="17" class="none_border ">
								<table class="bold pt8 xanh_3" style="width:100%;height:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
									...
									?>
									<tr class="pt6" <?php echo ($COUNT_LOT<6)?'style="height:35px;"':'';?> class="pt6" id="<?php echo 'row_'.$STT;?>">
										<td colspan="">&nbsp;<br/><?php echo $STT;?><br/>&nbsp;<br/></td>
										<td class="pt12" style="width:10%" colspan=""><?php echo $SO_LINE;?></td>
										<td class="pt8" style="width:12%" colspan=""><?php echo $ITEM;?></td>
										<td class="pt8" style="width:13%" colspan="3"><?php echo $INTERNAL_ITEM;?></td>
										<td class="pt10" style="width:6%" colspan=""><?php echo $QTY>0?number_format($QTY):'-';?></td>
										<td class="pt7" colspan="2"><?php echo $MATERIAL_CODE;?></td>
										<td class="pt9" style="width:10%" colspan="3"><?php echo $MATERIAL_QTY>0?number_format($MATERIAL_QTY):'-';?></td>
										<td class="pt7" style="width:6%" colspan=""><?php echo $LENGTH;?></td>
										<td class="pt7" style="width:6%" colspan=""><?php echo $WIDTH;?></td>
										<td class="pt7" style="width:13%" colspan="2"><?php echo $INK_CODE;?></td>
										<td class="pt9" style="width:6%" colspan=""><?php echo $INK_QTY>0?number_format($INK_QTY):'-';?></td>
