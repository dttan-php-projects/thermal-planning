...
$month_1_trim = 'TRIM'.date('ym', strtotime("-1 month")).'-';
$month_2_trim = 'TRIM'.date('ym').'-';
$month_3_trim = 'TRIM'.date('ym', strtotime("+1 month")).'-';
$month_1_sips = 'SIPS'.date('ym', strtotime("-1 month")).'-';
$month_2_sips = 'SIPS'.date('ym').'-';
$month_3_sips = 'SIPS'.date('ym', strtotime("+1 month")).'-';
$query = "SELECT $fields FROM save_material as s_m JOIN save_item as s_i ON s_i.NUMBER_NO = s_m.ID_SAVE_ITEM where (ID_SAVE_ITEM like '$month_1_trim%' OR ID_SAVE_ITEM like '$month_2_trim%' OR ID_SAVE_ITEM like '$month_3_trim%' OR ID_SAVE_ITEM like '$month_1_sips%' OR ID_SAVE_ITEM like '$month_2_sips%' OR ID_SAVE_ITEM like '$month_3_sips%') order by s_m.ID asc";
//echo $query;      die;  
